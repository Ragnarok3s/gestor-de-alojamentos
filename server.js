    ...
    <head>
      ...
      <style>
        ...
        @media (max-width:640px){
          ...
          .page-backoffice .bo-calendar-mobile__overview-row{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;padding:12px;align-items:start;text-align:left;}
          ...
          .page-backoffice .bo-calendar-mobile__overview-dates{font-size:.72rem;grid-column:1/2;}
