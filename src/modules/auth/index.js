...
const loginTemplateRenderer = getRenderer('auth/login.ejs');
const twoFactorTemplateRenderer = getRenderer('auth/twofactor.ejs');
const resetTemplateRenderer = getRenderer('auth/reset.ejs');
